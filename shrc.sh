...
then
  ...
  export HOMEBREW_BUNDLE_BREW_SKIP="rakudo-star nss aws-iam-authenticator docker docker-machine awscli awssume imagemagick kubernetes-cli kubectl kubectl@1.14 kustomize@2.0 kustomize@3.1 container-diff hyperscan github/bootstrap/elasticsearch@2.4"
